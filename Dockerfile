...
RUN echo "deb http://debian.ustc.edu.cn/ubuntu/ trusty main multiverse restricted universe\ndeb http://debian.ustc.edu.cn/ubuntu/ trusty-backports main multiverse restricted universe\ndeb http://debian.ustc.edu.cn/ubuntu/ trusty-proposed main multiverse restricted universe\ndeb http://debian.ustc.edu.cn/ubuntu/ trusty-security main multiverse restricted universe\ndeb http://debian.ustc.edu.cn/ubuntu/ trusty-updates main multiverse restricted universe\ndeb-src http://debian.ustc.edu.cn/ubuntu/ trusty main multiverse restricted universe\ndeb-src http://debian.ustc.edu.cn/ubuntu/ trusty-backports main multiverse restricted universe\ndeb-src http://debian.ustc.edu.cn/ubuntu/ trusty-proposed main multiverse restricted universe\ndeb-src http://debian.ustc.edu.cn/ubuntu/ trusty-security main multiverse restricted universe\ndeb-src http://debian.ustc.edu.cn/ubuntu/ trusty-updates main multiverse restricted universe " | tee /etc/apt/sources.list
...
RUN rm /usr/bin/ruby
RUN cp /usr/bin/ruby2.0 /usr/bin/ruby
